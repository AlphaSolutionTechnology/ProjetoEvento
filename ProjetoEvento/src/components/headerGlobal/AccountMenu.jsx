...
export default function AccountMenu({ isOpen }) {
  ...
  return (
    <motion.div
      ref={menuRef}
      className="absolute right-0 mt-2 w-48 rounded-lg bg-white backdrop-blur shadow-lg dark:bg-gray-800 dark:bg-opacity-80 dark:text-gray-200 z-50"
      ...
      <ul className="py-2 text-sm">
        ...
        <li>
          <button
            ...
            className="flex items-center px-4 py-2 w-full text-left text-red-500 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition duration-300 ease-in-out"
          >
