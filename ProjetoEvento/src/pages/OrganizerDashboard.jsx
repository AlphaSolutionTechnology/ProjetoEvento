...
const OrganizerDashboard = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8 text-center">Painel do Organizador</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <DashboardCard
          ...
          description="Crie e gerencie quizzes para os seu evento."
